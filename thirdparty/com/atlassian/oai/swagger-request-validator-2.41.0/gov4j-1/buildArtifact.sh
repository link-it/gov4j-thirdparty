...
unzip -q swagger-request-validator/swagger-request-validator-core/target/swagger-request-validator-core-2.41.0.jar -d JAR
cd JAR
cp ../patch_src/* .
...
jar -cfM ../swagger-request-validator-core/swagger-request-validator-core-2.41.0-gov4j-1.jar *
cd ..
rm -rf JAR
