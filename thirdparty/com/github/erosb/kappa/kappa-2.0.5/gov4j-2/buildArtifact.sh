...
cp ../kappa-2.0.5/src/main/java/com/github/erosb/kappa/operation/validator/util/convert/style/DeepObjectStyleConverter.java com/github/erosb/kappa/operation/validator/util/convert/style/
...
cp ../kappa-2.0.5/src/main/java/com/github/erosb/kappa/operation/validator/validation/ParameterValidator.java com/github/erosb/kappa/operation/validator/validation/
...
jar -cfM ../kappa/kappa-2.0.5-gov4j-2.jar *
cd ..
rm -rf JAR
