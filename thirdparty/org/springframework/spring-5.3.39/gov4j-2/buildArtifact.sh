...
cp ../patch_src/* .
jar -cfM ../spring-beans/spring-beans-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-context-support/spring-context-support-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-context/spring-context-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../spring-framework/spring-core/src/main/java/org/springframework/util/PatternMatchUtils.java org/springframework/util/
cp ../patch_src/* .
jar -cfM ../spring-core/spring-core-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-expression/spring-expression-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-jdbc/spring-jdbc-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-jms/spring-jms-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-test/spring-test-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-web/spring-web-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-webflux/spring-webflux-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-webmvc/spring-webmvc-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
...
cp ../patch_src/* .
jar -cfM ../spring-websocket/spring-websocket-5.3.39-gov4j-2.jar *
cd ..
rm -rf JAR
