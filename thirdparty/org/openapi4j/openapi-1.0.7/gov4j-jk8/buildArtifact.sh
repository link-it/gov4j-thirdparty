...
jar -cfM ../openapi-core/openapi-core-1.0.7-gov4j-jk8.jar *
cd ..
rm -rf JAR
...
jar -cfM ../openapi-parser/openapi-parser-1.0.7-gov4j-jk8.jar *
cd ..
rm -rf JAR
...
jar -cfM ../openapi-schema-validator/openapi-schema-validator-1.0.7-gov4j-jk8.jar *
cd ..
rm -rf JAR
...
cp ../openapi4j/openapi-operation-validator/src/main/java/org/openapi4j/operation/validator/validation/OperationValidator.java org/openapi4j/operation/validator/validation/
jar -cfM ../openapi-operation-validator/openapi-operation-validator-1.0.7-gov4j-jk8.jar *
cd ..
rm -rf JAR
