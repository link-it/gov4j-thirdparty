...
cd ${ARTIFACT_ID}
BASE_DIR=../../../../../../../
./${BASE_DIR}/buildRecompiledJarEnv.sh ${GROUP_ID} richfaces ${ARTIFACT_ID} ${LIB_VERSION} 4 "GNU LESSER GENERAL PUBLIC LICENSE, Version 2.1" "https://www.gnu.org/licenses/old-licenses/lgpl-2.1.txt"  ${BASE_DIR}
cp -rp ../README src/
...
unzip -q ${ARTIFACT_ID}-3.3.4.Final-gov4j-4.jar -d classes/
cd ..
