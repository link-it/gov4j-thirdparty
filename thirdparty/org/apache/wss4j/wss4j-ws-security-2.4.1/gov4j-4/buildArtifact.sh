...
cp ../patch_src/*README* .
cp ../patch_src/wss86.keystore.updated .
...
jar -cfM ../wss4j-ws-security-common/wss4j-ws-security-common-2.4.1-gov4j-4.jar *
cd ..
rm -rf JAR
...
jar -cfM ../wss4j-ws-security-dom/wss4j-ws-security-dom-2.4.1-gov4j-4.jar *
cd ..
rm -rf JAR
